...
public class AppliTestDAL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Article> listeArticleBic = articleDAO.selectByMarque("Bic");
			System.out.println("Articles de marque Bic " + listeArticleBic);
			
			List<Article> listArticleByMotCle = articleDAO.selectByMotCle("A4");
			System.out.println("Articles A4 " + listArticleByMotCle);
